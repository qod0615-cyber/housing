...
export const PropertyInspector: React.FC<PropertyInspectorProps> = ({
  ...
  if (!selectedRoom && !selectedItem) {
    return (
      <div className="bg-slate-900 border-l border-slate-800 w-80 p-4 text-slate-400 flex flex-col items-center justify-center text-center">
  ...
  if (selectedRoom) {
    return (
      <div className="bg-slate-900 border-l border-slate-800 w-80 p-4 text-slate-200 flex flex-col gap-4 overflow-y-auto">
        ...
        <div className="bg-slate-800/60 p-3 rounded-xl border border-slate-700/80">
          ...
          <p className="text-[11px] text-slate-400 mt-1">
            * 한국 아파트/주택 외벽 기준 보통 15~20cm, 내벽 10~15cm
          </p>
        </div>
